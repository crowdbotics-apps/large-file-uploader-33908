...
## Project Structure
    ...
    ├── large_file_uploader_33908  # Django project configurations
...
1. Clone this repo and `cd large_file_uploader_33908`
...
2. Clone this repo and `cd large_file_uploader_33908`
